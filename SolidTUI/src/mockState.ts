...
export const mockGameState: MockGameState = {
  ...
  remainingCards: 69,
  foundSets: 0,
  status: "Running - static OpenTUI mock",
  prompt: "Enter 3 cells (ie. 'a1 b1 c1')",
  board: [
    ...
    { id: "b3", shape: "oval", color: "blue", fill: "empty", count: 2, selected: true },
    { id: "b4", shape: "diamond", color: "green", fill: "shaded", count: 1 },
    { id: "c1", shape: "squiggle", color: "red", fill: "full", count: 2 },
    { id: "c2", shape: "diamond", color: "blue", fill: "empty", count: 2, selected: true },
    { id: "c3", shape: "oval", color: "red", fill: "full", count: 3 },
    { id: "c4", shape: "squiggle", color: "green", fill: "shaded", count: 1, selected: true },
  ],
};
